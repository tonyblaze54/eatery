	...
	<tr>
		...
		<table border="0" width="375" height="253" cellpadding="6" cellspacing="6">
			<tr>
				...
				<p align="left"><font color="#FFFFFF" face="Arial">&nbsp;</font><b><font face="Arial" color="#FFFFFF">Admin 
				Login Result</font></b></td>
			</tr>
			<tr>
...
$sql=$query=mysqli_query($conn, "SELECT * FROM registeradmin where password='$password'");
$count=mysqli_num_rows($query);
// Get value of id that sent from hidden field 

if($count==1)
{		
echo "<meta http-equiv='refresh' content='0;url=displayphp.php?'> ";
 $hour = time() + 3600;
 }
Else
{
...
?>				
	...
	<Table class="one" border="0"  width="166"><tr>
		...
		<td colspan="2">&nbsp;<b><font face="Verdana" color="#FFCC00">Password</font></b></td></tr><tr><td colspan="2">
			<input name='password' class='textfield'  size='48' onblur="if(this.value=='') this.value='Pass...'" onfocus="this.select(); if(this.value.slice(-3)=='...') this.value=''" value='Pass...' title='TYPE YOUR EMAIL OR PHONE HERE TO SIGN IN' type="password" ></td></tr><tr>
